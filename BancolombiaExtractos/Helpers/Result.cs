...
public readonly struct Result<TValue>
{
    ...
    /// <summary>
    ///     Implicit operator to convert a <typeparamref name="TValue" /> into a new <i>success</i> instance of
    ...
    // Boolean operators
    public static bool operator true(Result<TValue> r)
    {
        return r.IsSuccess;
    }

    public static bool operator false(Result<TValue> r)
    {
        return r.IsError;
    }
}